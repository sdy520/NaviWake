...
//				}
    ...
    public static int parseGrammarResultcallCmdmax(String json) {
        int ret=0;
        try {
            JSONTokener tokener = new JSONTokener(json);
            JSONObject joResult = new JSONObject(tokener);
    ...
    public static int parseGrammarResultcontactmin(String json) {
        int ret=0;
        try {
            JSONTokener tokener = new JSONTokener(json);
            JSONObject joResult = new JSONObject(tokener);
